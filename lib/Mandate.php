 ...
 * @property \StripeV2\StripeObject $customer_acceptance
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property \StripeV2\StripeObject $multi_use
 * @property string|\StripeV2\PaymentMethod $payment_method ID of the payment method associated with this mandate.
 * @property \StripeV2\StripeObject $payment_method_details
 * @property \StripeV2\StripeObject $single_use
