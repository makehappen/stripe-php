 ...
 * @property null|string|\StripeV2\Charge $charge The ID of the payment used to pay for the order. Present if the order status is <code>paid</code>, <code>fulfilled</code>, or <code>refunded</code>.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\StripeV2\Customer $customer The customer used for the order.
 ...
 * @property \StripeV2\OrderItem[] $items List of items constituting the order. An order can have up to 25 items.
 ...
 * @property null|\StripeV2\Collection $returns A list of returns that have taken place for this order.
 ...
 * @property null|\StripeV2\StripeObject $shipping The shipping address for the order. Present if the order is for goods to be shipped.
 * @property null|\StripeV2\StripeObject[] $shipping_methods A list of supported shipping methods for this order. The desired shipping method can be specified either by updating the order, or when paying it.
 ...
 * @property null|\StripeV2\StripeObject $status_transitions The timestamps at which the order status was updated.
...
class Order extends ApiResource
{
     ...
     *
     * @return \StripeV2\OrderReturn the newly created return
     */
