 ...
 * @property \StripeV2\StripeObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 ...
 * @property \StripeV2\StripeObject $verification_fields
 */
