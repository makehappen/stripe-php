 ...
 * @property string|\StripeV2\Customer $customer ID of the customer.
 * @property null|string|\StripeV2\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property string|\StripeV2\Invoice $invoice ID of the invoice.
 * @property \StripeV2\Collection $lines Line items that make up the credit note
 ...
 * @property null|string|\StripeV2\Refund $refund Refund related to this credit note.
 ...
 * @property \StripeV2\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \StripeV2\CreditNote the previewed credit note
     */
     ...
     * @throws \StripeV2\Exception\ApiErrorException if the request fails
     *
     * @return \StripeV2\Collection the list of credit note line items
     */
