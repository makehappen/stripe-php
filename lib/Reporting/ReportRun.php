 ...
 * @property \StripeV2\StripeObject $parameters
 ...
 * @property null|\StripeV2\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \StripeV2\ApiResource
{
