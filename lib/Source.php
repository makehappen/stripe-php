 ...
 * @property \StripeV2\StripeObject $ach_debit
 * @property \StripeV2\StripeObject $acss_debit
 * @property \StripeV2\StripeObject $alipay
 ...
 * @property \StripeV2\StripeObject $bancontact
 ...
 * @property \StripeV2\StripeObject $code_verification
 ...
 * @property \StripeV2\StripeObject $eps
 ...
 * @property \StripeV2\StripeObject $giropay
 * @property \StripeV2\StripeObject $ideal
 * @property \StripeV2\StripeObject $klarna
 ...
 * @property \StripeV2\StripeObject $multibanco
 * @property null|\StripeV2\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \StripeV2\StripeObject $p24
 * @property \StripeV2\StripeObject $receiver
 * @property \StripeV2\StripeObject $redirect
 * @property \StripeV2\StripeObject $sepa_credit_transfer
 * @property \StripeV2\StripeObject $sepa_debit
 * @property \StripeV2\StripeObject $sofort
 * @property \StripeV2\StripeObject $source_order
 ...
 * @property \StripeV2\StripeObject $three_d_secure
 ...
 * @property \StripeV2\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \StripeV2\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \StripeV2\Exception\ApiErrorException if the request fails
     *
     * @return \StripeV2\Source the detached source
     */
     ...
     * @throws \StripeV2\Exception\ApiErrorException if the request fails
     *
     * @return \StripeV2\Collection the list of source transactions
     */
