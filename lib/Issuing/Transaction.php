 ...
 * @property null|string|\StripeV2\Issuing\Authorization $authorization The <code>Authorization</code> object that led to this transaction.
 * @property null|string|\StripeV2\BalanceTransaction $balance_transaction ID of the <a href="https://stripe.com/docs/api/balance_transactions">balance transaction</a> associated with this transaction.
 * @property string|\StripeV2\Issuing\Card $card The card used to make this transaction.
 * @property null|string|\StripeV2\Issuing\Cardholder $cardholder The cardholder to whom this transaction belongs.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\StripeV2\Issuing\Dispute $dispute If you've disputed the transaction, the ID of the <a href="https://stripe.com/docs/api/issuing/disputes/object">dispute object</a>.
 ...
 */
class Transaction extends \StripeV2\ApiResource
{
