 ...
 * @property null|string|\StripeV2\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\StripeV2\Customer $customer The ID of the customer that the bank account is associated with.
