 ...
 * @property \StripeV2\OrderItem[] $items The items included in this order return.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string|\StripeV2\Order $order The order that this return includes items from.
 * @property null|string|\StripeV2\Refund $refund The ID of the refund issued for this return.
 */
